...
name: brand-analyzer
description: >
  Analyze a website to extract brand guidelines and produce a concise 1-2 paragraph brand summary
  suitable for passing to other AI agents as a quick reference. Use when a user provides a URL and
  asks for brand analysis, brand guidelines extraction, brand voice summary, or brand style reference.
  Triggers include: "analyze this brand", "brand guidelines", "brand summary", "brand voice",
  "brand style", "describe this brand", or any request to characterize a company's brand identity
  from their website.
---
...
> Acme Corp is a B2B cybersecurity platform that helps mid-market companies detect and respond to threats in real time. The brand voice is confident and direct, using short declarative sentences and minimal jargon to make complex security concepts accessible to non-technical decision-makers. Acme leans into urgency without being alarmist, favoring phrases like "stay ahead" and "take control" over fear-based messaging.
>
> The tone is professional but approachable, blending technical credibility with a human touch — blog posts often open with real-world scenarios before diving into solutions. Core values center on transparency, speed, and empowerment. Content targets CISOs and IT directors who value clarity and actionable insight over marketing fluff.