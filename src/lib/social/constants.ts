...
> = {
  instagram: {
    ...
    executionTools: ["instagram_get_profile", "instagram_list_posts", "instagram_get_post"],
  },
  facebook: {
    name: "Facebook",
    icon: "Facebook",
    description: "Access your Facebook page posts, reactions, and engagement",
    executionTools: ["facebook_get_profile", "facebook_list_posts", "facebook_get_post"],
  },
  tiktok: {
    name: "TikTok",
    icon: "TikTok",
    description: "Access your TikTok videos, views, and engagement metrics",
    executionTools: ["tiktok_get_profile", "tiktok_list_posts", "tiktok_get_post"],
  },
  x: {
    name: "X (Twitter)",
    icon: "X",
    description: "Access your tweets, impressions, and engagement metrics",
    executionTools: ["x_get_profile", "x_list_posts", "x_get_post"],
  },
  linkedin: {
    name: "LinkedIn",
    icon: "LinkedIn",
    description: "Access your LinkedIn posts and professional content",
    executionTools: ["linkedin_get_profile", "linkedin_list_posts", "linkedin_get_post"],
  },
};
